...
export default function FeatureImportanceCard() {
  ...
  useEffect(() => {
    async function fetchFeatures() {
      ...
      setError(false);
      try {
        const response = await fetch(`/api/feature-importance?disease=${disease}&limit=8`);
        if (response.ok) {
      ...
      <Card className="shadow-md">
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="font-headline">Feature Importance Analysis</CardTitle>
              <CardDescription className="mt-1">
                Which factors drive disease outbreak predictions
              </CardDescription>
            </div>
        ...
        <CardContent>
          <div className="flex flex-col items-center justify-center p-8">
            ...
            <p className="mt-2 text-sm font-medium text-destructive">
              Could not load feature importance data.
            </p>
          ...
          <>
                    ...
                    <div className="p-4">
                      ...
                      {isExpanded && (
                        <div className="mt-4 pl-14 pr-4 pb-2">
                          <div className="rounded-lg border-l-4 border-blue-500 bg-blue-50/50 p-3">
            ...
            <div className="mt-6 rounded-lg bg-muted/30 p-3 text-xs text-muted-foreground">
              <p>
                ...
                between each feature and next week's disease cases. Higher absolute values indicate stronger predictive relationships.
              </p>
            </div>
          </>
        )}
